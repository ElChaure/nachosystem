...
class ClientesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','index','view','reporte1','analvenc','edoctacliente'),
				'users'=>array('@'),
			),
	...
	{
		$this->renderPartial('reporte1');
	}
	
	public function actionAnalvenc()
	{
		$this->renderPartial('analvenc');
	}
	public function actionEdoctacliente($id)
	{
		$this->renderPartial('edoctacliente',$id);
	}	
