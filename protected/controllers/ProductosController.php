...
class ProductosController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','reporte1','reporte2','delete','reporte3','kardex'),
				'users'=>array('@'),
			),
	...
	{
		$this->renderPartial('reporte2');
	}
	
	public function actionReporte3()
	{
		$this->renderPartial('reporte3');
	}
	
		public function actionKardex($id)
	{
		$this->renderPartial('kardex',$id);
	}	
