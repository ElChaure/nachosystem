...
class Salidadet_tmpController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','admin','delete','index','view','autocompleteFinal','findproducto','create_codprov'),
				'users'=>array('@'),
			),
	...
	{
		$model=new Salidadet_tmp;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Salidadet_tmp']))
		{
			$model->attributes=$_POST['Salidadet_tmp'];
		...
		public function actionCreate_codprov()
	{
		$model=new Salidadet_tmp;
		...
		if(isset($_POST['Salidadet_tmp']))
		{
            ...
            if ($exists){                     
               if($model->save())
                  $this->redirect(array('create_codprov'));
               }
             else
               {                            
                  Yii::app()->user->setFlash('error', "El producto no existe en la base de datos!");
	...
	{
		$dataProvider=new CActiveDataProvider('Salidadet_tmp');
	...
	public function actionAdmin()
	{
		...
		$model=new Salidadet_tmp('search');
		
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Salidadet_tmp']))
			$model->attributes=$_GET['Salidadet_tmp'];
	 ...
	 * @return Salidadet_tmp the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Salidadet_tmp::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Salidadet_tmp $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='salidadet-tmp-form')
		{
